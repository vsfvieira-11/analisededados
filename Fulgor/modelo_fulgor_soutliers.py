...
tabela1 = pd.read_csv("tabela_combinada_fulgor_sem_outliers.csv",index_col=0)
...
X_train, X_test, y_train, y_test = train_test_split(
    ...
    Y,
    test_size=0.33,
    random_state=7, #manter a mesma divisão em diferentes execuções para que o código seja reprodutível
...
fig.update_layout( #dados do gráfico
    title="PLS Ponto de Fulgor - Medido vs Previsto",
    xaxis_title="Valor medido (°C)",
    yaxis_title="Valor previsto (°C)"
)
