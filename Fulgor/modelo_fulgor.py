#Rotina para criação de um modelo PLS para previsão do ponto de fulgor a partir dos espectros
...
tabela1 = pd.read_csv("tabela_combinada_fulgor.csv",index_col=0)
...
X_train, X_test, y_train, y_test = train_test_split(
    ...
    random_state=42, #manter a mesma divisão em diferentes execuções para que o código seja reprodutível para testes
...
fig.update_layout( #dados do gráfico
    title="PLS Fulgor - Medido vs Previsto",
    xaxis_title="Valor medido",
