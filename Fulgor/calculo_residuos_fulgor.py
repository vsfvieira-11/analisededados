...
fig_residuos.update_layout(
    title="Gráfico de Resíduos — PLS Ponto de Fulgor",
...
tabela_sem_outliers.to_csv("tabela_combinada_fulgor_sem_outliers.csv")

print(f"\nArquivo salvo: tabela_combinada_fulgor_sem_outliers.csv")
