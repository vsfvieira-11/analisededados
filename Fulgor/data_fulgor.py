#Rotina para criação do Dataset do Ponto de Fulgor
#Organizar os dados em um único arquivo CSV, juntando os espectros e as propriedades (ponto de fulgor)
...
caminho_excel = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'dados_fulgor.xlsx')
...
tabela_final.to_csv("tabela_combinada_fulgor.csv", index=False)