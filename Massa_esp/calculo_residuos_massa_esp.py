...
fig_residuos.update_layout(
    title="Gráfico de Resíduos — PLS Massa Específica (Dados Brutos)",
...
tabela_sem_outliers.to_csv("tabela_combinada_massa_esp_sem_outliers.csv")

print(f"\nArquivo salvo: tabela_combinada_massa_esp_sem_outliers.csv")
