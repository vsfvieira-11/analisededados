#Rotina para criação do Dataset da Massa Específica
...
caminho_excel = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'dados_massa_esp.xlsx')
...
tabela_final.to_csv("tabela_combinada_massa_esp.csv", index=False)